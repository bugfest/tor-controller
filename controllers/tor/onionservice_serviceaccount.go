...
func (r *OnionServiceReconciler) reconcileServiceAccount(ctx context.Context, onionService *torv1alpha3.OnionService) error {
...
func torServiceAccount(onion *torv1alpha3.OnionService) *corev1.ServiceAccount {
